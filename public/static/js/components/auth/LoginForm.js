...
class LoginForm extends HTMLElement {
  ...
  render() {
    ...
    googleLoginLink.appendChild(
      document.createTextNode(" Sign in with Google")
    );
    ...
    footerText.textContent =
      "© 2025 Football Quiz Platform. All rights reserved.";
  ...
  async checkAuthentication() {
    ...
    try {
      ...
      this.showError("Error checking authentication");
    }
  }
  ...
  displayUsernameForm() {
    ...
    const googleSigninButton = this.shadowRoot.querySelector(
