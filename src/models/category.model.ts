...
export class CategoryModel {
  ...
  static async update(id: number, data: UpdateCategoryDto): Promise<Category | null> {
    ...
    const result = await db.query(
      ...
      [
        data.category_name !== undefined ? data.category_name : category.category_name,
        data.category_description !== undefined ? data.category_description : category.category_description,
        id
      ]
    );
