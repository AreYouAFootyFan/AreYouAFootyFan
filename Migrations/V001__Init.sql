...
ALTER TABLE badge_history ADD FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE badge_history ADD FOREIGN KEY (badge_id) REFERENCES badges (badge_id);

ALTER TABLE quizzes ADD FOREIGN KEY (category_id) REFERENCES categories (category_id);

ALTER TABLE quizzes ADD FOREIGN KEY (created_by) REFERENCES users (user_id);

ALTER TABLE questions ADD FOREIGN KEY (quiz_id) REFERENCES quizzes (quiz_id);

ALTER TABLE questions ADD FOREIGN KEY (difficulty_id) REFERENCES difficulty_levels (difficulty_id);

ALTER TABLE answers ADD FOREIGN KEY (question_id) REFERENCES questions (question_id);

ALTER TABLE quiz_attempts ADD FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE quiz_attempts ADD FOREIGN KEY (quiz_id) REFERENCES quizzes (quiz_id);

ALTER TABLE user_responses ADD FOREIGN KEY (attempt_id) REFERENCES quiz_attempts (attempt_id);

ALTER TABLE user_responses ADD FOREIGN KEY (question_id) REFERENCES questions (question_id);

ALTER TABLE user_responses ADD FOREIGN KEY (chosen_answer) REFERENCES answers (answer_id);
